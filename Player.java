...
public class Player  implements Serializable {
    ...
    public void buyDevCard(){
        ...
        if(resources.containsAll(requirements) && Board.getPileDevCard().size()>=1){
            ...
            if(Board.getPileDevCard().getFirst().getType()=="victory point"){
                allPoints+=1;
            }
    ...
    public void addResources(ArrayList<Resource> r){
        for(Resource res:r)resources.add(res);
        }
    public ArrayList<Resource> getResources() {return resources;}
    public void removeResources(ArrayList<Resource> r){
        
        System.out.println("removeResources: "+r.size()+" "+resources.size());
        for(Resource res:r)resources.remove(res);
        System.out.println("removeResources: "+r.size()+" "+resources.size());
    }
    public void addVillage(Village v) {
        System.out.println("addVillage: "+v.getIndex()+" "+v.getVertex());
        villages.add(v);
        allPoints+=1;
        publicPoints+=1;
    }
    ...
    public void addRoad(Road r) {
        this.roads.add(new Road(r.getIndexHexagon(), r.getv1(), r.getv2(), number));
